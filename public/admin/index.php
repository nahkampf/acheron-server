        ...
        <div id="menu">
            <div class="pure-menu">
                ...
                <ul class="pure-menu-list">
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Signals</a></li>
                    <li class="pure-menu-item menu-item-divided pure-menu-selected"><a href="#"
                            class="pure-menu-link">Sensors</a></li>
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Archive/DB</a></li>
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Messages</a></li>
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Video comms</a></li>
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Players</a></li>
                    <li class="pure-menu-item"><a href="" class="pure-menu-link">Admin tools</a></li>
